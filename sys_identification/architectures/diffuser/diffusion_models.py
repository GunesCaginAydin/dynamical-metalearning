...
class LinearAttention(nn.Module):
    ...
    """
    def __init__(self, dim, heads=16, dim_head=256):
        super().__init__()
...
class TemporalUnet(nn.Module):
    """
    Unet architecture for temporal denoising of trajectories
    """
    def __init__(
        self,
        horizon,
    ...
    def configure_optimizers(self, weight_decay, learning_rate, betasoptim, device_type):
        """
    ...
    def forward(self, x, cond, force, time):
