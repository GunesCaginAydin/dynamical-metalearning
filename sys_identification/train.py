...
maxepoch = 16
random.shuffle(datadict['trainlist'])
for i in range(maxepoch):
  for data in datadict['trainlist']:
      print(data)
      datasets.load(data, itr=args.total_sim_iterations) # load current data from trainlist
  ...
  axs1[0].plot(datasets.training_loss_list, label='training loss')
  axs1[0].grid()
  axs1[0].legend()
  axs1[0].set_xlabel('Iterations')
  axs1[0].set_ylabel('Loss')

  axs1[1].plot(datasets.validation_loss_list, label='validation loss')
  axs1[1].grid()
  axs1[1].legend()
  axs1[1].set_xlabel('Iterations')
  axs1[1].set_ylabel('Loss')

  fig1.suptitle("Training and Validation Losses")


  fig2, axs2 = plt.subplots(2,1)

  axs2[0].semilogy(datasets.training_loss_list, label='training loss')
  axs2[0].grid()
  axs2[0].legend()
  axs2[0].set_xlabel('Iterations')
  axs2[0].set_ylabel('Loss')

  axs2[1].semilogy(datasets.validation_loss_list, label='validation loss')
  axs2[1].grid()
  axs2[1].legend()
  axs2[1].set_xlabel('Iterations')
  axs2[1].set_ylabel('Loss')

  fig2.suptitle("Training and Validation Losses")
